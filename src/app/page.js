...
export default function Home() {
  ...
  return (
    <div
      className={`max-w-[97%] p-8 mx-auto my-4 border rounded-3xl flex flex-wrap-reverse justify-evenly items-center overflow-hidden select-none ${theme.mainTheme} ${theme.colorBorder}`}
    >
      {/* Left Section */}
      <div data-aos="fade-right" className="max-w-lg mt-4">
        ...
        <p className={`text-lg mt-8 ${theme.subTextColor}`}>
          Join the platform where tailors create virtual shops and users try-on
          outfits and place orders instantly!
        </p>
        <Link href={"/#"}>
