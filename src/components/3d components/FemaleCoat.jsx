...
const FemaleCoat = ({ morphValues, morphTargets, texture, color }) => {
  ...
  useEffect(() => {
    ...
    loader.load("/models/female-coat/female-coat.glb", (loadedGltf) => {
      setGltf(loadedGltf);
    });
  }, []);
...
FemaleCoat.morphTargets = ["Length", "Arms", "Waist"];

export default FemaleCoat;
